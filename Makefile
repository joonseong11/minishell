...
SRC			=	main.c \
				...
				utils/utils_envir_error.c init/heredoc_signal_handler.c test.c \
				whiplash_img/get_next_line_utils.c whiplash_img/get_next_line.c whiplash_img/whiplash_93.c
